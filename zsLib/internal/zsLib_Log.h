...
#define ZS_INTERNAL_LOG_INSANE(xMsg)                                    if (ZS_INTERNAL_IS_LOGGING(Insane))  {(::zsLib::Log::singleton())->log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Insane, ::zsLib::String(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
