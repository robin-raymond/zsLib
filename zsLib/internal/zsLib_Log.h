...
#define ZS_INTERNAL_LOG_BASIC(xMsg)                                     if (ZS_INTERNAL_IS_LOGGING(Basic))  {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Basic, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_DETAIL(xMsg)                                    if (ZS_INTERNAL_IS_LOGGING(Detail)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Detail, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_DEBUG(xMsg)                                     if (ZS_INTERNAL_IS_LOGGING(Debug))  {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Debug, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_TRACE(xMsg)                                     if (ZS_INTERNAL_IS_LOGGING(Trace))  {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Trace, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_INSANE(xMsg)                                    if (ZS_INTERNAL_IS_LOGGING(Insane)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::Insane, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}

#define ZS_INTERNAL_LOG(xLevel, xMsg)                                   if (ZS_INTERNAL_IS_LOGGING(xLevel)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Informational, ::zsLib::Log::xLevel, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_WARNING(xLevel, xMsg)                           if (ZS_INTERNAL_IS_LOGGING(xLevel)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Warning, ::zsLib::Log::xLevel, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_ERROR(xLevel, xMsg)                             if (ZS_INTERNAL_IS_LOGGING(xLevel)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Error, ::zsLib::Log::xLevel, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
#define ZS_INTERNAL_LOG_FATAL(xLevel, xMsg)                             if (ZS_INTERNAL_IS_LOGGING(xLevel)) {::zsLib::Log::log(ZS_GET_SUBSYSTEM(), ::zsLib::Log::Fatal, ::zsLib::Log::xLevel, ::zsLib::Log::Params(xMsg), ZS_INTERNAL_FUNCTION_FILE_LINE);}
